...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/room5.jpg" alt="Los Angeles" class="d-block" style="width:100%">
    ...
    <div class="carousel-item">
      <img src="images/room51.jpg" alt="Chicago" class="d-block" style="width:100%">
      <div class="carousel-caption">
        <h3>PANORAMA</h3>
    ...
    <div class="carousel-item">
        <img src="images/room52.jpg" alt="Chicago" class="d-block" style="width:100%">
        <div class="carousel-caption">
          <h3>PANORAMA</h3>
          <p>Thank you, Chicago!</p>
        </div> 
  ...
  <div class="overlay">
    <div class="row">
        ...
        <div class="container p-5 my-3">
          ...
          <div class="container pt-5 my-5 bg-light">
            ...
            <button type="button" id="btnsuc1" onclick="function2()">ΚΡΑΤΗΣΗ ΤΩΡΑ</button>
              ...
              <div id="hold">
                <p class="t5">Απευθείας κράτηση από <h4>187&euro;</h4></p>
      ...
      <div class="col-4"><br><br><br><br>
        <p class="t4">Οι ευρύχωρες και άνετα σχεδιασμένες Junior σουίτες βρίσκονται στους τελευταίους ορόφους του ξενοδοχείου Titania διαθέτοντας μπαλκόνι με υπέροχη θέα στον λόφο της Ακρόπολης και στην πόλη της Αθήνας. Κλασικά διακοσμημένες προσφέροντας μια ζεστή κι άνετη διαμονή, περιλαμβάνουν ένα μεγάλο υπνοδωμάτιο, καθιστικό με καναπέ-κρεβάτι, τραπεζάκι, 2 καρέκλες, επιφάνεια εργασίας και ευρύχωρο μαρμάρινο μπάνιο με διπλό νιπτήρα, τζακούζι και ξεχωριστό ντους. Μέγεθος 40 τ.μ., μπορεί να φιλοξενήσει έως και 4 άτομα. Προσφορά καλάθι με φρούτα κατά την άφιξη. Δωρεάν μπουκάλι μεταλλικό νερό ανά άτομο κάθε μέρα που μένετε μαζί μας. Δωρεάν υπηρεσία δωματίου για το πρωινό.
...
<div class="container-fluid mt-3 p-5 my-3">
    <div class="row">
      <div class="col-4">
        <img src="images/junior1.jpg" width="100%" height="100%">
      </div>
      <div class="col-4">
        <img src="images/junior2.jpg" width="100%" height="100%">
      </div>
      <div class="col-4">
        <img src="images/junior3.jpg" width="100%" height="100%">
      </div>
    </div>
    <br>
    <div class="row">
      <div class="col-4">
        <img src="images/junior4.jpg" width="100%" height="100%">
      </div>
    </div>
  </div>
